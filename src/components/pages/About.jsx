...
function About() {
  return (
    <section className="flex flex-col gap-4 smo">


<div className="flex flex-col  justify-center items-center">
    <picture className="w-[350px] ">
    ...
    <div className="text-4xl flex flex-wrap animate-wiggle  gap-3 justify-center items-center mt-8">
